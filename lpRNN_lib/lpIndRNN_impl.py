...
class lpIndRNNCell(Layer):
    """low pass Independently Recurrent Neural Networks Cell class.
    Modified from the paper [Independently Recurrent Neural Network (IndRNN): Building A Longer and Deeper RNN](https://arxiv.org/abs/1803.04831)
    ...
    def __init__(self, units,
                 ...
                 implementation=2,
                 **kwargs):
        super(lpIndRNNCell, self).__init__(**kwargs)
    ...
    def call(self, inputs, states, training=None):
        ...
        h = self.activation(h)
        h = self._retention_ratio * h_tm1 + (1 - self._retention_ratio)*h
    ...
    def get_config(self):
        ...
        base_config = super(lpIndRNNCell, self).get_config()
...
class lpIndRNN(RNN):
    ...
    def __init__(self, units,
        ...
        super(lpIndRNN, self).__init__(cell,
    ...
    def build(self, input_shape):
        ...
        super(lpIndRNN, self).build(input_shape)

    def call(self, inputs, mask=None, training=None, initial_state=None, constants=None):
        self.cell._dropout_mask = None
        self.cell._recurrent_masks = None
        return super(lpIndRNN, self).call(inputs,
                                        mask=mask,
                                        training=training,
    ...
    def get_config(self):
        config = {'units': self.units,
                  ...
                  'recurrent_dropout': self.recurrent_dropout,
                  'implementation': self.implementation}
        base_config = super(lpIndRNN, self).get_config()
