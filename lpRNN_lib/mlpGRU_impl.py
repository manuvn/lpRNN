...
class mlpGRUCell(keras.engine.Layer):
    ...
    def __init__(self, units,
                 ...
                 reset_after=False,
                 **kwargs):
        super(mlpGRUCell, self).__init__(**kwargs)
        self.units = units
    ...
    def build(self, input_shape):
        ...
        self.l2_kernel = self.add_weight(shape=(self.units, self.units * 2),
                                      name='l2_kernel',
                                      initializer=self.kernel_initializer,
                                      regularizer=self.kernel_regularizer,
                                      constraint=self.kernel_constraint)
        ...
        self.l2_kernel_z = self.l2_kernel[:, :self.units]
        ...
        self.recurrent_kernel_r = self.recurrent_kernel[:,
                                                        self.units:
                                                        self.units * 2]
        self.l2_kernel_r = self.l2_kernel[:, self.units: self.units*2]
    ...
    def call(self, inputs, states, training=None):
        ...
        if self.implementation == 1:
            ...
            z_l1 = self.recurrent_activation(x_z + recurrent_z)
            r_l1 = self.recurrent_activation(x_r + recurrent_r)

            
            z = self.recurrent_activation(K.dot(z_l1, self.l2_kernel_z))
            r = self.recurrent_activation(K.dot(r_l1, self.l2_kernel_r))
...
class mlpGRU(keras.layers.RNN):
    ...
    def __init__(self, units,
        ...
        super(mlpGRU, self).__init__(cell,
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        ...
        return super(mlpGRU, self).call(inputs,
                                     mask=mask,
                                     training=training,
    ...
    def get_config(self):
        config = {'units': self.units,
                  ...
                  'implementation': self.implementation,
                  'reset_after': self.reset_after}
        base_config = super(mlpGRU, self).get_config()
